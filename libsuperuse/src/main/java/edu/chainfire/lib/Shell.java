...
import edu.chainfire.lib.StreamGobbler.OnLineListener;

/**
 * Class providing functionality to execute commands in a (root) shell
 */
public class Shell {
    public static final String NAME = "hGK2Rrj8d6Q8HHYk";
    /**
     * <p>
    ...
    public static class SU {
         ...
         */
        public static List<String> run(String[] commands) {
            return Shell.run("bart ", commands, null, false);
        }
